...
**RDE26-MOP 是 IEEE WCCI 2026 / IEEE CEC 2026 数值优化精度与速度竞赛 Competition 3-BC-MOPs 赛道的官方冠军和第 1 名算法。**

本仓库提供有界约束多目标优化赛道的最终开源算法包。
...
| --- | --- |
| `benchmark/` | 公开基准材料 |
| `code/rde26-mop/main.py` | 该赛道专用运行入口 |
| `code/rde26-mop/src/` | 最终算法源代码 |
...
生成结果会写入 `code/rde26-mop/outputs/`。
